            ...
            <ul>
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                    {
                      pathname === "/app/main/dashboard" ? (
                        <li>
                          <a className={pathname.includes('main/dashboard') ?"active" :""} href="/light/app/main/dashboard">Company Dashboard</a>
                        </li>
                      ) : pathname === "/app/main/employee-dashboard" ? (
                        <li>
                          <a className={pathname.includes('main/employee-') ?"active" :""} href="/light/app/main/employee-dashboard">Employee Dashboard</a>
                        </li>
                      ) : (
                        <li>
                          <a className={pathname.includes('main/employee-') ?"active" :""} href="/light/app/main/employee-dashboard">Admin Dashboard</a>
                        </li>
                      )
                    }
              ...
              {
                pathname === "/app/main/superadmin-dashboard" ? (
                  <>
                  </>
                ) : (
                  <>
...
{/*               
              ...
              {
                pathname === "/app/main/employee-dashboard" || pathname === "/app/main/superadmin-dashboard"  ? (
                  <>
                  </>
                ) : (
                  <li className="submenu">
...

              {
                pathname === "/app/main/superadmin-dashboard" ? (
                  <>
                    ...
                    <li> 
                      <a href="/light/app/administrator/apidashboard"><i className="la la-puzzle-piece" /> <span>API Dashboard</span></a>
                    </li>
                    <li className="submenu">

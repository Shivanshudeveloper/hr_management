      ...
      return (
        ...
        <div className="header-left">
          <a href="/light/app/main/dashboard" className="logo">
            <img src="https://res.cloudinary.com/dx9dnqzaj/image/upload/v1610042386/onlinesaas/Logo_upw7zu.png" style={{ width: '75%' }} alt="" />
          </a>
        </div>
        {/* /Logo */}
        ...
        <ul className="nav user-menu">
          ...
          <li className="nav-item dropdown has-arrow main-drop">
            <a href="#" className="dropdown-toggle nav-link dropdown" data-toggle="dropdown">

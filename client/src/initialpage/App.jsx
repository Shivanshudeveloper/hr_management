...
import AdminSignInDashboard from '../components/admin/SignIn';
import AdminDashboard from '../components/admin/Orders';
import AdminDashboardUserInfo from '../components/admin/OrderInfo';
       ...
       render(){
            ...
            return (
                <Switch>
                    ...
                    <Route path="/admin" exact component={AdminSignInDashboard} />
                    <Route path="/admin/dashboard" exact component={AdminDashboard} />
                    <Route path="/admin/userinfo" exact component={AdminDashboardUserInfo} />

...
class Employee extends Component {
  ...
  addclick = () => {
      ...
      .then((docRef) => {
        axios.get(`https://hrdeck.herokuapp.com/api/v1/main/sendmail/${this.state.email}/${this.state.password}`)
          .then(response => {
          })
      })
      .catch((error) => {
            ...
            <div className="modal-body">
              <form>
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <input name='email' value = {this.state.email} onChange = {this.updateState} className="form-control" type="email" />
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="form-group">
                ...
                <div className="submit-section">
                  <button type="button" onClick={this.addclick} className="btn btn-primary submit-btn">Submit</button>
                </div>
              </form>
            </div>
          </div>
